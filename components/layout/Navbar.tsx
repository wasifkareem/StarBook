...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className="grid grid-cols-3 items-center w-full  px-6 h-20"
          ...
          <Link href={`${isSignedIn ? "/app" : "/"}`}>
            <div className="flex gap-2 text-2xl font-bold italic">
              ...
              <Cover className=" flex">
                ...
                {state.pro && (
                  <p
                    className=" text-sm h-fit px-2 rounded-2xl bg-gradient-to-br from-yellow-300 via-yellow-400 to-yellow-600 text-yellow-900 font-bold shadow-lg border border-yellow-500"
                    style={{
                      background:
                        "linear-gradient(145deg, #fbbf24, #f59e0b, #d97706)",
                      boxShadow:
                        "inset 0 1px 0 rgba(255,255,255,0.5), 0 2px 4px rgba(0,0,0,0.3)",

          ...
          <div className="flex flex-col items-center md:pb-10 p-10 gap-8">
            <div className="text-lg flex flex-col justify-center md:text-2xl font-mono">
              ...
              <p className="text-lg my-12 text-gray-600 bg-[#ffffff62] shadow-2xl shadow-white font-light max-w-2xl self-center text-center">
                Use Starbook to collect testimonails in minutes and embed them
                on your websites without any developer help.
              </p>
            </div>
            <div
              className="flex rounded-full flex-wrap gap-4 shadow-black bg-white justify-center items-center"
              style={{
                boxShadow:
                  '0 0 0 1px hsl(var(--border)), 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06)',
              }}
            >
              <Button>
            ...
            <div>
              <div className=" my-10 md:my-32 md:mt-44 ">
                <p className=" text-xl md:text-4xl font-mono text-center my-3 ">
                  Add Testimonials to your website without any coding
                </p>
                <p className=" text-center my-5 mt-10 font-mono">
                  Copy and paste our HTML code to your website to get a
                  Testimonial wall like below
                </p>
              </div>
            </div>
            ...
            <div className=" mt-4 lg:mt-40  lg:max-w-7xl flex flex-col gap-32 ">
              <h2 className="  md:text-4xl font-light text-center font-mono text-gray-800">
                Collect and Display Testimonials all in one place
              </h2>
              ...
              <div className="  grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="  flex justify-center flex-col gap-2 lg:px-16">
                  <span className=" text-primary text-xl">Easy to manage</span>
                  <p className=" text-3xl font-mono">
                  ...
                  <p className=" text-lg text-neutral-600 mt-3">
                    ...
                    but it&apos;s designed for your social proof!
                  </p>
                </div>
              </div>
              <div className="  grid grid-cols-1 lg:grid-cols-2">
                <div className="  flex justify-center flex-col gap-2 lg:px-16">
                  ...
                  <p className=" text-3xl font-mono">
                    Add tweets as Testimonials
                  </p>
                  <p className=" text-lg text-neutral-600 mt-3">
                    If people are talking about your startup/company on twitter,
                    bring those tweets here and use them as testimonials
                  </p>
                </div>
                <div className=" flex justify-center mt-16 md:mt-0">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
              ...
              {/* <div className="  grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="  flex justify-center flex-col gap-2 lg:px-16">
                  ...
                  <p className=" text-lg text-neutral-600 mt-3">
                    ...
                    favorite testimonials. You can embed it to your website in

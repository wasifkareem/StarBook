    ...
    return (
      <div className=" w-full flex justify-center">
        <div className="flex flex-col w-fit items-start gap-2 md:pt-20">
          <a
            href="/app"
            className=" flex gap-1 text-base text-[#81878d] transition-all cursor-pointer hover:text-secondary items-center"
          >
            <ArrowLeft size={18} />
            Back to Home
          </a>
            ...
            <Card className="w-fit bg-white">
              <CardContent className="flex flex-col gap-3">
                <div className="flex justify-between items-center">
                  <p className="text-xl font-semibold font-mono opacity-65">
                    Starbook
                  </p>
                ...
                <ul className="list-disc mt-7 ml-6 flex flex-col gap-2 md:max-w-96 opacity-65">
                  ...
                  <li>
                    Generate upto 2 AI-Insights per day based on the collected
                    testimonials
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="w-fit shadow-yellow-glow">
              <CardContent className="flex flex-col gap-3 items-end">
                ...
                <ul className="list-disc mt-7 ml-6 flex flex-col gap-2 md:max-w-96">
                  ...
                  <li>
                    Generate upto 10 AI-Insights per day based on the collected
                    testimonials
                  </li>
                </ul>
